//! # micro-time — Clock source and Pacer
//!
...
use micro_core::{Module, ModuleCtx, ModuleId, Topic};
...
impl Clock {
    ...
    pub fn hz(id: impl Into<String>, channel: impl Into<micro_core::Channel>, hz: f64) -> Self {
    ...
    pub fn every(
        id: impl Into<String>,
        channel: impl Into<micro_core::Channel>,
        interval: Duration,
    ) -> Self {
        Self {
            id: ModuleId::new(id),
