//! # framelite-video — the video sink adapter
//!
//! A video sink *pulls* frames from the [media data plane](framelite_media) — the zero-copy,
...
//! the platform weight framelite stays out of. This crate is just the framework-side contract:
...
/// A module that pumps the freshest [`Frame`] from a [`latest`](framelite_media::latest) mailbox
