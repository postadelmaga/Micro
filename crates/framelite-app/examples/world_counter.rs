//! `cargo run -p framelite-app --example world_counter`
//!
...
//! * the **world** ([`WorldModule`](framelite_app::WorldModule), wired by [`App::world`])
...
impl Module for Printer {
    ...
    fn subscriptions(&self) -> Vec<framelite_protocol::Channel> {
        vec![STATE.into()]
    }
